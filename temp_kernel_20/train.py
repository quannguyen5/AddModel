    ...
    config = {"model_id": "20", "model_name": "M\u00f4 h\u00ecnh 2p2", "model_type": "Human Detection", "version": "v1.0.13", "epochs": 100, "batch_size": 16, "image_size": 640, "learning_rate": 0.001}

    # Dataset path
    dataset_path = "../input/yolo-training-dataset-20/dataset.yaml"
    ...
    def on_train_epoch_end(trainer):
        ...
        if (trainer.epoch + 1) % 5 == 0:  # Save every 5 epochs
            trainer.model.export(f"output/epoch_{trainer.epoch + 1}.onnx")
